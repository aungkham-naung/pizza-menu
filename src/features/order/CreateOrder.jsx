      ...
      <Form method="POST" action="/order/new">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            ...
            name="priority"
            id="priority"
            className="accent-yelow-400 h-6 w-6 focus:outline-none focus:ring focus:ring-yellow-400 focus:ring-offset-2"
            value={withPriority}
        ...
        <div>
          {/* creating a hidden input field to push cart's data without altering field */}
...
export async function action({ request }) {
  //getting form field's data
  const formData = await request.formData();
  const data = Object.fromEntries(formData);
  console.log(data);

  //creating a holder for order
  const order = {
    ...data,
